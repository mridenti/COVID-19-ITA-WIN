...
int main(int argc, char** argv) {
    ...
    else if (argc == 1)
    {
        ...
        printf_s("Uso: \n");
        printf_s("\tcsv_to_input [nome do cen�rio] \n");
        printf_s("\n");
        printf_s("Exemplos: \n");
        printf_s("1) Usando o cen�rio \"Default\":\n");
        printf_s("\tcsv_to_input \n");
        printf_s("2) Usando um cen�rio chamado de \"HardLockdown\":\n");
        printf_s("\tcsv_to_input HardLockdown\n");
        printf_s("\n");
        printf_s("Cen�rio: \n");
        printf_s("Um cen�rio � uma pasta dentro de input/cenarios com o nome do cen�rio e contendo os arquivos .csv referentes aos par�metros da simula��o que ser�o utilizados");
        printf_s("\t\n");
        return 0;
    }
    ...
    else if(argc == 1)
    {
        ...
        printf_s("\t ou \n");
        printf_s("csv_to_input \n");
        printf_s("\t (Neste caso usar� o cen�rio default) \n");
    }
