...
plt.suptitle(u'Curva total das populações em compartimentos, CUR - modelo SEAHIR')
...
plt.suptitle(u'Infectados e recuperados por faixa etária, CUR - modelo SEAHIR')
...
plt.suptitle(u'Estimativa de hospitalizados, leitos e óbitos por faixa etária, CUR - modelo SEAHIR')
