...
temp_date = datetime.date(2020, 05, 31) - datetime.date(year, month, day)
...
# Attenuation factor set to wild scenario
g_e0 = 1.0

# First scenario
# Lock, level 4 until 31th of july, relax after 31th july
...
# Lock, level 3 from 31 of May to 31 of july, then level 1
subprocess.call(['python', 'cenario_generator.py', '-i', cenario_folder, '-d', str(day_init), str(day_next_1),
                 str(day_next_2), str(day_next_3), '-m', '3',
...
# Lock, level 2 from 31 of May to 31 of july, then level 1
subprocess.call(['python', 'cenario_generator.py', '-i', cenario_folder, '-d', str(day_init), str(day_next_1),
                 str(day_next_2), str(day_next_3), '-m', '3',
                 '-I0', str(ni*g_s), '-R0', str(r_0), '-Rp', str(r_0), '-p', str(g_e0), str(g_e1), str(g_e1), str(g_e1),
                 '-itv', '0', '10', '8', '6'])
...
# Lock, level 3 from 31 of may to 30 of june, level 2 from 30 of june to 31 of july, then level 1
subprocess.call(['python', 'cenario_generator.py', '-i', cenario_folder, '-d', str(day_init), str(day_next_1),
                 str(day_next_2), str(day_mid), '-m', '3',
                 '-I0', str(ni*g_s), '-R0', str(r_0), '-Rp', str(r_0), '-p', str(g_e0), str(g_e1), str(g_e1), str(g_e1),
                 '-itv', '0', '10', '9', '8', '-ex', '6', str(day_next_3)])
os.chdir("..")
subprocess.call(['bin/csv_to_input', cenario_folder], stdout=open(os.devnull, 'wb'))
subprocess.call(['bin/spatial_covid0d_estrat.exe', 'input/generated-input.txt', '/'.join(['output', output_file]),
                 '3'], stdout=open(os.devnull, 'wb'))
...
# Lock, then simply open on 31 of May
subprocess.call(['python', 'cenario_generator.py', '-i', cenario_folder, '-d', str(day_init), str(day_next_1),
                 str(day_next_2), str(day_next_3), '-m', '3',
...
plt.plot(t_dates, I1, '-', color='blue', label=u'Level 4 until the 31st of May, 31st of July')
plt.plot(t_dates, I6, '-', color='orange', label=u'Level 4 until 31st of July, \n then relax to level 1 until the '
                                                 u'end of the year')
plt.plot(t_dates, I2, '-', color='m', label=u'Level 4 until 31st of May, level 3 until 31st of July')
plt.plot(t_dates, I4, '-', color='y', label=u'Level 4 until 31st of May, relax to level 3 \n until 30th of June, '
                                            u'relax to level 2 until 31st of July')
plt.plot(t_dates, I3, '-', color='green', label=u'Level 4 until 31st of May, level 2 until 31st of July')
plt.plot(t_dates, I5, '-', color='red', label=u'Simply open on 31st of May')
...
save_fig('_scenarioC_infected.svg')
...
plt.axvline(day_2, linestyle='--', linewidth=1.0, color='black')
plt.axvline(day_3, linestyle='--', linewidth=1.0, color='black')
plt.plot(t_dates, C1, '-', color='blue', label=u'Level 4 until the 31st of May, 31st of July')
plt.plot(t_dates, C6, '-', color='orange', label=u'Level 4 until 31st of July, \n then relax to level 1 until the '
                                                 u'end of the year')
plt.plot(t_dates, C2, '-', color='m', label=u'Level 4 until 31st of May, level 3 until 31st of July')
plt.plot(t_dates, C4, '-', color='y', label=u'Level 4 until 31st of May, relax to level 3 \n until 30th of June, '
                                            u'relax to level 2 until 31st of July')
plt.plot(t_dates, C3, '-', color='green', label=u'Level 4 until 31st of May, level 2 until 31st of July')
plt.plot(t_dates, C5, '-', color='red', label=u'Simply open on 31st of May')
...
save_fig('_scenarioC_casualties.svg')
...
plt.plot(t_dates, H1, '-', color='blue', label=u'Level 4 until the 31st of May, 31st of July')
plt.plot(t_dates, H6, '-', color='orange', label=u'Level 4 until 31st of July, \n then relax to level 1 until the '
                                                 u'end of the year')
plt.plot(t_dates, H2, '-', color='m', label=u'Level 4 until 31st of May, level 3 until 31st of July')
plt.plot(t_dates, H4, '-', color='y', label=u'Level 4 until 31st of May, relax to level 3 \n until 30th of June, '
                                            u'relax to level 2 until 31st of July')
plt.plot(t_dates, H3, '-', color='green', label=u'Level 4 until 31st of May, level 2 until 31st of July')
plt.plot(t_dates, H5, '-', color='red', label=u'Simply open on 31st of May')
...
plt.plot(t_dates, R1, '-', color='blue', label=u'Level 4 until the 31st of May, 31st of July')
plt.plot(t_dates, R6, '-', color='orange', label=u'Level 4 until 31st of July, \n then relax to level 1 until the '
                                                 u'end of the year')
plt.plot(t_dates, R2, '-', color='m', label=u'Level 4 until 31st of May, level 3 until 31st of July')
plt.plot(t_dates, R4, '-', color='y', label=u'Level 4 until 31st of May, relax to level 3 \n until 30th of June, '
                                            u'relax to level 2 until 31st of July')
plt.plot(t_dates, R3, '-', color='green', label=u'Level 4 until 31st of May, level 2 until 31st of July')
plt.plot(t_dates, R5, '-', color='red', label=u'Simply open on 31st of May')
...
save_fig('_scenarioC_recovered.svg')
